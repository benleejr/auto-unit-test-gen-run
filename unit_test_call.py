...
cors = CORS(app, resources={
    r"/run_tests": {"origins": "http://localhost:3000"},
    r"/generate-pdf": {"origins": "http://localhost:3000"},
    r"/download-pdf/*": {"origins": "http://localhost:3000"},
...
@app.route('/run_tests', methods=['POST', 'OPTIONS'])
